...
dependencies {
    // 核心能力：队列、stage、下载、缓存
    implementation("com.github.gegeName.effect:effect-core:0.0.8")

    // 需要 SVGA 时引入
    implementation("com.github.gegeName.effect:effect-svga:0.0.8")

    // 需要 alpha-MP4/VAP 时引入
    implementation("com.github.gegeName.effect:effect-mp4-vap:0.0.8")

    // 需要 alpha-MP4/YYEVA 时引入
    implementation("com.github.gegeName.effect:effect-mp4-yyeva:0.0.8")

    // 需要 alpha-MP4/AlphaPlayer 时引入
    implementation("com.github.gegeName.effect:effect-mp4-alpha:0.0.8")

    // 需要 GIF/Glide 时引入
    implementation("com.github.gegeName.effect:effect-gif-glide:0.0.8")
}
```
...
```kotlin
implementation("com.github.gegeName:effect-svga:0.0.8")
```
